...
public class Question33 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_question33);                //set to the current page
        ...
        buttonA.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {                        //define what to do on click
                //do something
                MainActivity.profile.setResponse(33, 'A');
                openQuestion34();                    //go to next question
            }
        });
        ...
        buttonB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //do something
                MainActivity.profile.setResponse(33, 'B');
                openQuestion34();                    //go to next question
            }
        });
    }
